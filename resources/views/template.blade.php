...
<!-- Mirrored from themesbrand.com/velzon/html/default/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 12 May 2025 05:36:21 GMT -->
...
<head>
    ...
    <!-- jsvectormap css -->
    <link href="{{ asset('default') }}/assets/libs/jsvectormap/jsvectormap.min.css" rel="stylesheet" type="text/css" />
                ...
                <div class="navbar-header">
                    <div class="d-flex">
                        ...
                        <div class="navbar-brand-box horizontal-logo">
                            <a href="{{ asset('default') }}/index.html" class="logo logo-dark">
                                <span class="logo-sm">
                            ...
                            <a href="{{ asset('default') }}/index.html" class="logo logo-light">
                                <span class="logo-sm">
                                    <img src="assets/images/logo-sm.png" alt="" height="22">
                                </span>
                                <span class="logo-lg">
                            ...
                            <div class="dropdown-menu dropdown-menu-lg" id="search-dropdown">
                                <div data-simplebar style="max-height: 320px;">
                                    ...
                                    <div class="dropdown-item bg-transparent text-wrap">
                                        <a href="{{ asset('default') }}/index.html"
                                    ...
                                    <!-- item-->
                                    <a href="{{ asset('default') }}/javascript:void(0);"
                                ...
                                <div class="text-center pt-3 pb-1">
                                    <a href="{{ asset('default') }}/pages-search-results.html"
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <div class="dropdown ms-1 topbar-head-dropdown header-item">
                            ...
                            <div class="dropdown-menu dropdown-menu-end">
                                ...
                                <!-- item-->
                                <a href="{{ asset('default') }}/javascript:void(0);"
                                    class="dropdown-item notify-item language" data-lang="sp" title="Spanish">
                                ...
                                <!-- item-->
                                <a href="{{ asset('default') }}/javascript:void(0);"
                                    class="dropdown-item notify-item language" data-lang="gr" title="German">
                                ...
                                <!-- item-->
                                <a href="{{ asset('default') }}/javascript:void(0);"
                                    class="dropdown-item notify-item language" data-lang="it" title="Italian">
                                ...
                                <!-- item-->
                                <a href="{{ asset('default') }}/javascript:void(0);"
                                    class="dropdown-item notify-item language" data-lang="ru" title="Russian">
                                ...
                                <!-- item-->
                                <a href="{{ asset('default') }}/javascript:void(0);"
                                    class="dropdown-item notify-item language" data-lang="ch" title="Chinese">
                                ...
                                <!-- item-->
                                <a href="{{ asset('default') }}/javascript:void(0);"
                                    class="dropdown-item notify-item language" data-lang="fr" title="French">
                            ...
                            <div class="dropdown-menu dropdown-menu-lg p-0 dropdown-menu-end">
                                <div class="p-3 border-top-0 border-start-0 border-end-0 border-dashed border">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col-auto">
                                            <a href="{{ asset('default') }}/#!" class="btn btn-sm btn-soft-info">
                                                View All Apps
                                ...
                                <div class="p-2">
                                    <div class="row g-0">
                                        <div class="col">
                                            <a class="dropdown-icon-item" href="{{ asset('default') }}/#!">
                        ...
                        <div class="dropdown topbar-head-dropdown ms-1 header-item">
                            ...
                            <div class="dropdown-menu dropdown-menu-xl dropdown-menu-end p-0 dropdown-menu-cart"
                                ...
                                <div data-simplebar style="max-height: 300px;">
                                    <div class="p-2">
                                        <div class="text-center empty-cart" id="empty-cart">
                                            ...
                                            <a href="{{ asset('default') }}/apps-ecommerce-products.html"
                                            ...
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="flex-grow-1">
                                                    <h6 class="mt-0 mb-1 fs-14">
                                                        <a href="{{ asset('default') }}/apps-ecommerce-product-details.html"
                                ...
                                <div class="p-3 border-bottom-0 border-start-0 border-end-0 border-dashed border"
                                    ...
                                    <a href="{{ asset('default') }}/apps-ecommerce-checkout.html"
                                        ...
                                        <ul class="nav nav-tabs dropdown-tabs nav-tabs-custom"
                                            ...
                                            <li class="nav-item waves-effect waves-light">
                                                <a class="nav-link active" data-bs-toggle="tab"
                                                    href="{{ asset('default') }}/#all-noti-tab" role="tab"
                                                    aria-selected="true">
                                                    All (4)
                                                </a>
                                            </li>
                                            <li class="nav-item waves-effect waves-light">
                                                <a class="nav-link" data-bs-toggle="tab"
                                                    href="{{ asset('default') }}/#messages-tab" role="tab"
                                                    aria-selected="false">
                                                    Messages
                                                </a>
                                            </li>
                                            <li class="nav-item waves-effect waves-light">
                                                <a class="nav-link" data-bs-toggle="tab"
                                                    href="{{ asset('default') }}/#alerts-tab" role="tab"
                                                    aria-selected="false">
                                                    Alerts
                                                </a>
                                            </li>
                                        ...
                                        <div data-simplebar style="max-height: 300px;" class="pe-2">
                                            <div
                                                ...
                                                <div class="d-flex">
                                                    ...
                                                    <div class="flex-grow-1">
                                                        <a href="{{ asset('default') }}/#!" class="stretched-link">
                        ...
                        <div class="dropdown ms-sm-3 header-item topbar-user">
                            ...
                            <div class="dropdown-menu dropdown-menu-end">
                                ...
                                <a class="dropdown-item" href="{{ asset('default') }}/apps-chat.html"><i
                                        class="mdi mdi-message-text-outline text-muted fs-16 align-middle me-1"></i>
                                    <span class="align-middle">Messages</span></a>
                                <a class="dropdown-item" href="{{ asset('default') }}/apps-tasks-kanban.html"><i
                                        class="mdi mdi-calendar-check-outline text-muted fs-16 align-middle me-1"></i>
                                    <span class="align-middle">Taskboard</span></a>
                                <a class="dropdown-item" href="{{ asset('default') }}/pages-faqs.html"><i
                                ...
                                <a class="dropdown-item"
                                    href="{{ asset('default') }}/pages-profile-settings.html"><span
                                        class="badge bg-success-subtle text-success mt-1 float-end">New</span><i
                                        class="mdi mdi-cog-outline text-muted fs-16 align-middle me-1"></i> <span
                                        class="align-middle">Settings</span></a>
                                <a class="dropdown-item" href="{{ asset('default') }}/auth-lockscreen-basic.html"><i
...
@yield('content')
                                    ...
                                    <div class="card-body p-0">
                                                ...
                                                <div class="acitivity-item py-3 d-flex">
                                                    ...
                                                    <div class="flex-grow-1 ms-3">
                                                        <h6 class="mb-1 lh-base">Today offers by <a
                                                                href="{{ asset('default') }}/apps-ecommerce-seller-details.html"
                                                ...
                                                <div class="acitivity-item py-3 d-flex">
                                                    ...
                                                    <div class="flex-grow-1 ms-3">
                                                        ...
                                                        <p class="text-muted mb-0">Flash sale by <a
                                                                href="{{ asset('default') }}/javascript:void(0);"
                                        ...
                                        <div class="p-3 mt-2">
                                            ...
                                            <ol class="ps-3 text-muted">
                                                <li class="py-1">
                                                    <a href="{{ asset('default') }}/#" class="text-muted">Mobile &
                                                        Accessories <span class="float-end">(10,294)</span></a>
                                                </li>
                                                <li class="py-1">
                                                    <a href="{{ asset('default') }}/#" class="text-muted">Desktop
                                                        <span class="float-end">(6,256)</span></a>
                                                </li>
                                                <li class="py-1">
                                                    <a href="{{ asset('default') }}/#" class="text-muted">Electronics
                                                        <span class="float-end">(3,479)</span></a>
                                                </li>
                                                <li class="py-1">
                                                    <a href="{{ asset('default') }}/#" class="text-muted">Home &
                                                        Furniture <span class="float-end">(2,275)</span></a>
                                                </li>
                                                <li class="py-1">
                                                    <a href="{{ asset('default') }}/#" class="text-muted">Grocery
                                                        <span class="float-end">(1,950)</span></a>
                                                </li>
                                                <li class="py-1">
                                                    <a href="{{ asset('default') }}/#" class="text-muted">Fashion
                                                        <span class="float-end">(1,582)</span></a>
                                                </li>
                                                <li class="py-1">
                                                    <a href="{{ asset('default') }}/#" class="text-muted">Appliances
                                                        <span class="float-end">(1,037)</span></a>
                                                </li>
                                                <li class="py-1">
                                                    <a href="{{ asset('default') }}/#" class="text-muted">Beauty,
                                                        Toys & More <span class="float-end">(924)</span></a>
                                                </li>
                                                <li class="py-1">
                                                    <a href="{{ asset('default') }}/#" class="text-muted">Food &
                                                        Drinks <span class="float-end">(701)</span></a>
                                                </li>
                                                <li class="py-1">
                                                    <a href="{{ asset('default') }}/#" class="text-muted">Toys &
                                                        Games <span class="float-end">(239)</span></a>
                                                </li>
                                            </ol>
    ...
    <div class="offcanvas offcanvas-end border-0" tabindex="-1" id="theme-settings-offcanvas">
        ...
        <div class="offcanvas-footer border-top p-3 text-center">
            <div class="row">
                ...
                <div class="col-6">
                    <a href="{{ asset('default') }}/https://1.envato.market/velzon-admin" target="_blank"
    ...
    <!-- Vector map-->
    <script src="{{ asset('default') }}/assets/libs/jsvectormap/jsvectormap.min.js"></script>
...
<!-- Mirrored from themesbrand.com/velzon/html/default/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 12 May 2025 05:37:26 GMT -->
